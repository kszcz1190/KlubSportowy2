...
namespace KlubSportowy.Migrations
{
    ...
    [Migration("20241112222811_migracjasklep")]
    partial class migracjasklep
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KlubSportowy.Models.PrzedmiotModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CenaPrzedmiotu")
                        .HasColumnType("int");

                    b.Property<bool>("CzyDostepny")
                        .HasColumnType("tinyint(1)");

                    b.Property<int>("IloscPrzedmiotu")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PrzedmiotModel");
                });

            modelBuilder.Entity("KlubSportowy.Models.RezerwacjaModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PrzedmiotModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PrzedmiotModelId");

                    b.ToTable("RezerwacjaModel");
                });
            ...
            modelBuilder.Entity("KlubSportowy.Models.RezerwacjaModel", b =>
                {
                    ...
                    b.HasOne("KlubSportowy.Models.PrzedmiotModel", "przedmiotModel")
                        .WithMany()
                        .HasForeignKey("PrzedmiotModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("applicationUser");

                    b.Navigation("przedmiotModel");
                });
